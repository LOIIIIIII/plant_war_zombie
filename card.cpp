...
void Card::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    ...
    //放上空卡片 和 植物图片
    painter->drawPixmap(QRect(-50, -70, 100, 140), QPixmap(":/bgc/res\\Other/Card.png"));
    painter->drawPixmap(QRect(-35, -42, 70, 70), QPixmap(":/plant/res\\Plant/" + text + ".png"));
...
void Card::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
    ...
    QImage image(":/plant/res\\Plant/" + text + ".png");
    mime->setText(text);
